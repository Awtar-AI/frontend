...
export default function RecruiterLoginPage() {
    ...
    const [role, setRole] = useState<"job-seeker" | "recruiter">("recruiter");
            ...
            <div className="flex-1 flex flex-col justify-center max-w-md w-full mx-auto">
                ...
                <form className="space-y-4" onSubmit={handleLogin}>
                    ...
                    <div className="space-y-1.5">
                        <label htmlFor="rec-email" className="text-sm font-semibold text-gray-700">
                            Email Address
                        </label>
                    ...
                    {/* Organization */}
                    <div className="space-y-1.5">
                        <label htmlFor="rec-org" className="text-sm font-semibold text-gray-700">
                            Organization
                        </label>
                        <div className="relative">
