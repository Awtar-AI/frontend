    ...
    >
      ...
      <div className="space-y-1.5">
        ...
        <PhoneInput
          ...
          inputClassName="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
