...
export type RecruiterIndustry =
  (typeof recruiterIndustryOptions)[number]["value"];
...
export type RecruiterRegisterFormData = z.infer<
  typeof recruiterRegisterFormSchema
>;
...
export function toRecruiterPayload(
  data: RecruiterRegisterFormData,
