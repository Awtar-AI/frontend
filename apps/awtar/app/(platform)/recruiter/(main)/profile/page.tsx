      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        ...
        {organizationId && organizationQuery.data && (
          <div className="mt-5 grid md:grid-cols-2 gap-4">
            ...
            {organizationQuery.data.latitude &&
              organizationQuery.data.longitude && (
                <div className="md:col-span-2">
                  <LocationDisplay
                    latitude={organizationQuery.data.latitude}
                    longitude={organizationQuery.data.longitude}
                    organizationName={organizationQuery.data.organization_name}
