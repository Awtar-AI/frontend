...
export function PostJobForm() {
  ...
  const onSubmit = handleSubmit(
    ...
    (errors) => {
      ...
      const firstErrorKey = Object.keys(errors)[0] as keyof CreateJobFormData;
      if (firstErrorKey) {
        let element = document.querySelector(`[name="${firstErrorKey}"]`);

        // Special handling for location field (uses custom picker)
        if (firstErrorKey === "latitude" && !element) {
          element = document.getElementById("location-picker");
        }
    ...
    <>
      {!organizationId && (
        <div className="mb-6 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
          Your session does not currently have an active organization. The jobs
          API reads `organization_id` from the JWT, so please sign in again
          before posting.
        </div>
      )}
        ...
        <div className="flex flex-col gap-6">
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm text-gray-900 outline-none transition-all placeholder:text-gray-400"
            />
            {errors.title && (
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <textarea
                ...
                className="w-full min-h-[180px] resize-y rounded-lg border border-gray-200 p-4 pr-36 text-sm text-gray-900 outline-none transition-all placeholder:text-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            {!isRemote && (
              <JobLocationPicker form={form} error={errors.latitude?.message} />
            )}
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                {...register("currency")}
                placeholder="USD"
                className="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm text-gray-900 outline-none placeholder:text-gray-400"
              />
              {errors.currency && (
                <p className="text-xs text-red-600">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm text-gray-900 outline-none placeholder:text-gray-400 disabled:bg-gray-50"
              />
              {errors.minSalary && (
                <p className="text-xs text-red-600">
          ...
          <div className="grid md:grid-cols-2 gap-6 items-start">
            <div className="space-y-2">
              ...
              <input
                ...
                type="datetime-local"
                {...register("deadline")}
                className="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm text-gray-900 outline-none"
              />
              {errors.deadline && (
                <p className="text-xs text-red-600">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full min-h-[120px] p-4 text-sm text-gray-900 border border-gray-200 rounded-lg outline-none resize-none placeholder:text-gray-400 focus:ring-2 focus:ring-blue-500"
            />
