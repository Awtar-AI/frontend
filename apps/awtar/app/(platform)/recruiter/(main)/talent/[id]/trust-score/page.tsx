                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-blue-600 rounded-xl p-5 text-white">
                        ...
                        <p className="text-xs mb-4 opacity-80">
                            Generate a full compliance report for legal and HR records.
                        </p>
                            ...
                            {CANDIDATE.verification.map((v) => (
                                ...
                                >
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <span
                                            className={`text-[9px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded ${v.tagColor}`}
                                        >
                                            {v.tag}
                                        </span>
                                    </div>
                                    ...
                                    <div className="w-full bg-gray-100 rounded-full h-1.5">
                                        <div
                                            className={`h-1.5 rounded-full ${v.progressColor}`}
                        ...
                        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
                            ...
                            <div className="space-y-3">
                                {CANDIDATE.riskFlags.map((flag, i) => (
                                    <div
                                        key={i}
                                        className={`flex items-start gap-3 p-3 rounded-lg border ${severityStyles[flag.severity]}`}
                                    >
                                        ...
                                        <span
                                            className={`text-[9px] font-black uppercase tracking-widest flex-shrink-0 mt-0.5`}
                                        >
                        ...
                        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
                            ...
                            <div className="space-y-3">
                                {[
                                    {
                                        label: "FILE ORIGIN",
                                        value: CANDIDATE.resumeSource.filename,
                                    },
                                    {
                                        label: "PARSING ENGINE",
                                        value: CANDIDATE.resumeSource.engine,
                                    },
                                    {
                                        label: "ANALYSIS LATENCY",
                                        value: CANDIDATE.resumeSource.latency,
                                    },
                                    {
                                        label: "CONFIDENCE LEVEL",
                                        value: `✦ ${CANDIDATE.resumeSource.confidence}`,
                                    },
                                ].map((item) => (
                                    <div
                                        key={item.label}
