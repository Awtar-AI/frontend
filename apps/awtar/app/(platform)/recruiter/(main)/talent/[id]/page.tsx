        ...
        skills: [
            {
                ...
                items: ["JavaScript (ES6+)", "TypeScript", "Python", "Go", "SQL"],
            },
            {
        ...
        education: [
            {
                ...
                year: "Class of 2016, Magna Cum Laude",
                note: "",
            },
        ],
        contact: {
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-4 mt-2 text-xs text-gray-500 flex-wrap">
                                    ...
                                    <span className="flex items-center gap-1 text-blue-600 font-semibold cursor-pointer">
                                        <ExternalLink className="w-3.5 h-3.5" /> {talent.openTo}
                                    </span>
                                </div>
                            </div>
                                ...
                                <div key={group.category}>
                                    ...
                                    <div className="flex flex-wrap gap-1.5">
                                        {group.items.map((skill) => (
                                            <span
                                                key={skill}
                                                className="px-2.5 py-1 bg-gray-100 text-gray-700 text-[11px] font-semibold rounded-full"
                                            >
                                                {skill}
                                            </span>
                                        ))}
                ...
                <div className="space-y-5">
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
                        ...
                        <p className="text-[11px] text-center text-gray-500 mb-3">
                            Candidate&apos;s background, identity, and employment history have been
                            officially verified.
                        </p>
                        ...
                        <Link
                            href={`/recruiter/talent/${talent.id}/trust-score`}
                            className="mt-4 w-full flex items-center justify-center gap-2 text-xs font-bold text-blue-600 hover:text-blue-700 border border-blue-100 bg-blue-50 rounded-lg py-2 transition-colors"
                        >
                    ...
                    <div className="bg-blue-50 border border-blue-100 rounded-xl p-5">
                        <h3 className="text-xs font-bold text-blue-700 mb-1">
                            ✦ AI Match Analysis
                        </h3>
                        <p className="text-xs text-blue-600 mb-3 leading-snug">
                            Highly compatible with the <strong>Senior Frontend Architect</strong>{" "}
                            role. Exhibits strong leadership potential and exceptional expertise in
                            modern JS frameworks. Cultural fit score: 96%.
                        </p>
                        <div className="space-y-2">
                            {[
                                {
                                    label: "Role Compatibility",
                                    value: talent.aiMatch.compatibility,
                                },
                        ...
                        <Link
                            href={`/recruiter/talent/${talent.id}/xai-analysis`}
                            className="mt-4 w-full inline-flex items-center justify-center gap-1.5 text-xs font-bold text-blue-700 hover:text-blue-800 underline"
                        >
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
                        ...
                        <div className="space-y-2.5 text-xs">
                            <div className="flex items-start gap-2">
                                <span className="text-gray-400 font-semibold w-16 flex-shrink-0">
                                    EMAIL
                                </span>
                                <a
