...
const TALENTS = [
    ...
    },
    {
        ...
        rate: "$50/hr",
        summary:
            "Creative Product Designer with a focus on mobile applications and user-centric design.",
    ...
    },
    {
        ...
        rate: "$57/hr",
        summary:
            "Service designer focused on improving customer experiences across various touchpoints.",
    ...
    },
    {
        ...
        rate: "$54/hr",
        summary:
            "Innovative interaction designer with expertise in user flow optimization and accessibility.",
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                {currentTalents.map((talent) => (
                    <div
                        key={talent.id}
                        className="bg-white rounded-xl border border-gray-200 shadow-sm p-5 hover:shadow-md transition-shadow flex flex-col gap-3"
                    >
                        {/* Top */}
                        <div className="flex items-start gap-3">
                            ...
                            <div className="min-w-0">
                                <Link
                                    href={`/recruiter/talent/${talent.id}`}
                                    className="font-bold text-sm text-gray-900 hover:text-blue-600 transition-colors leading-tight"
                                >
                                    {talent.name}
                                </Link>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {talent.skills.map((skill) => (
                                <span
                                    key={skill}
                                    className="px-2.5 py-1 bg-gray-100 text-gray-600 text-[11px] font-semibold rounded-full"
                                >
                                    {skill}
                                </span>
                            ))}
                        ...
                        <div className="flex items-center gap-3 pt-1">
                            ...
                            >
                                <Bookmark
                                    className={`w-3.5 h-3.5 ${talent.saved ? "fill-blue-600" : ""}`}
                                />
