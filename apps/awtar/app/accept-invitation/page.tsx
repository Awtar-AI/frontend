    ...
    <RecruiterAuthLayout reversed>
      <div className="flex-1 flex flex-col justify-center max-w-md w-full mx-auto text-center">
        ...
        <p className="text-gray-500 mb-8">
          This invitation link is invalid or missing the required token. Ask
          your HR admin to resend the invitation.
        </p>
        <Link
  ...
  return (
    <RecruiterAuthLayout reversed>
      <div className="flex-1 flex flex-col justify-center max-w-md w-full mx-auto text-center">
        ...
        <p className="text-gray-500 mb-8">
          Your HR account has been created successfully. You can now sign in to
...
function AcceptInvitationPageContent() {
  ...
  const invitationPrefill = useMemo(() => {
    ...
    return {
      firstName: readStringClaim(payload, [
        "first_name",
        "FirstName",
        "firstName",
      ]),
  ...
  const isNameLocked = Boolean(
    invitationPrefill.firstName || invitationPrefill.lastName,
  );
  ...
  useEffect(() => {
    ...
    invitationPrefill.email,
    invitationPrefill.firstName,
    invitationPrefill.lastName,
    reset,
  ]);
    ...
    <RecruiterAuthLayout reversed>
      <div className="flex-1 flex flex-col justify-center max-w-md w-full mx-auto">
        ...
        <p className="text-gray-500 mb-8 text-center">
          Complete your HR account setup to join your organization&apos;s
          recruiter workspace.
        </p>
