        ...
        {mutation.isSuccess ? (
          ...
          <>
            ...
            >
              <Link
                href="/login"
                className={`inline-flex items-center gap-2 ${isDark ? "text-blue-500 hover:text-blue-600" : "text-blue-500 hover:text-blue-600"}`}
              >
                <ArrowLeft className="h-4 w-4" />
                Back to login
              </Link>
            ...
            <div className="mb-8">
              ...
              <p
                className={`mt-3 ${isDark ? "text-awtar-slate" : "text-gray-600"}`}
              >
