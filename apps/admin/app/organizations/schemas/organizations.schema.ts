...
>;
export type AdminOrganizationsFilters = z.infer<
  typeof adminOrganizationsFiltersSchema
>;
...
export function parseOrganizationListResponse(
  data: unknown,
): OrganizationListResponse {
  return organizationListResponseSchema.parse(data);
}

export function parseOrganizationDetailResponse(
  data: unknown,
